# Generated by Powerlevel10k configuration wizard on 2026-04-23 at 21:42 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=022
  ...
  # only show vi_mode on the active prompt
  function p10k-on-post-prompt() {
    p10k display '1/right/(vi_mode)'=hide
  }
  function p10k-on-pre-prompt() {
    p10k display '1/right/(vi_mode)'=show
  }
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=28
